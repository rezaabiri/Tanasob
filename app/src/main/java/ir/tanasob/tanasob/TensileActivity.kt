...
class TensileActivity : AppCompatActivity() {
    private lateinit var binding:ActivityTensileBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this, R.layout.activity_tensile)
        init()
    }
    ...
    private fun video1(){
        val uri = Uri.parse("android.resource://" + packageName + "/" + R.raw.tensile1)
    ...
    private fun video2(){
        val uri = Uri.parse("android.resource://" + packageName + "/" + R.raw.tensile2)
    ...
    private fun video3(){
        val uri = Uri.parse("android.resource://" + packageName + "/" + R.raw.tensile3)
    ...
    private fun video4(){
        val uri = Uri.parse("android.resource://" + packageName + "/" + R.raw.tensile4)
