...
import ir.tanasob.tanasob.databinding.ActivityWaistBinding

class WaistActivity : AppCompatActivity() {
    private lateinit var binding:ActivityWaistBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this, R.layout.activity_waist)
        init()
    }
    ...
    private fun video1(){
        val uri = Uri.parse("android.resource://" + packageName + "/" + R.raw.waist1)
    ...
    private fun video2(){
        val uri = Uri.parse("android.resource://" + packageName + "/" + R.raw.waist2)
    ...
    private fun video3(){
        val uri = Uri.parse("android.resource://" + packageName + "/" + R.raw.waist3)
    ...
    private fun video4(){
        val uri = Uri.parse("android.resource://" + packageName + "/" + R.raw.waist4)
